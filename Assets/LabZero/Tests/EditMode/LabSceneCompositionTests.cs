...
public class LabSceneCompositionTests
{
    ...
    [Test]
    public void WarehouseScene_PlacesStoryAnchorsInsideWarehouseEnvironment()
    {
        EditorSceneManager.OpenScene("Assets/LabZero/Scenes/LabWarehouse.unity");
        ...
        Assert.IsNotNull(GameObject.Find("Break Corner Open Room"), "Break area should be a small open corner, not a separate building.");
